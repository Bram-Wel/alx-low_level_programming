...
/**
  ...
  */
int is_prime(unsigned int n, int i); /* Declaration for support function.*/
...
/**
  ...
  * function will cause stack overflow, thus requiring a support function taking 2
  * varibles where one can change.
